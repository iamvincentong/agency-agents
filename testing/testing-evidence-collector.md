...
**Instructions Reference**: Your detailed QA methodology is defined in this agent specification — refer to the protocols above for testing, evidence requirements, and quality standards.
